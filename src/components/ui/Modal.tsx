...
export function Modal({ isOpen, onClose, children, title }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 animate-in fade-in">
      <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full sm:max-w-md shadow-xl animate-in zoom-in-95 duration-200 max-h-[60vh] sm:max-h-[90vh] flex flex-col">
        {title && (
